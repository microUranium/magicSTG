...
func _random_position() -> Vector2:
  ...
  match side:
    0: return Vector2(randf_range(rect.position.x, rect.end.x), rect.position.y - 32)
    1: return Vector2(rect.position.x - 32, randf_range(rect.position.y, rect.position.y + y_limit))
    2: return Vector2(rect.end.x + 32, randf_range(rect.position.y, rect.position.y + y_limit))
  return Vector2.ZERO
