...
enum ProjectileDirection { TO_TARGET, CURRENT_VELOCITY, FIXED, RANDOM, SPREAD }  # ターゲットに向かう  # 現在の速度方向を維持  # 固定方向  # ランダム方向  # 拡散
...
@export var rotate_during_approach: bool = false  # 接近フェーズ中に回転を開始するか
